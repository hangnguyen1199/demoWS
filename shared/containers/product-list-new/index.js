 ...
 * ****************************************************************************
 */
const ProductListNewContainer = (props) => {
    ...
    const data_bread_crumb = { name: 'Sản phẩm mới', path_name: PageList.PRODUCT_LIST_NEW.SERVER };
...
export default ProductListNewContainer;
