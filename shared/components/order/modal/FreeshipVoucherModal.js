...
FreeshipVoucherModal.propTypes = {
    voucherList: PropTypes.array,
};

FreeshipVoucherModal.defaultProps = {
    voucherList: [],
};

function FreeshipVoucherModal(props) {
    ...
    return (
        <div>
            <ModalComponent
                ...
                className="freeship-voucher-modal"
                title={props.title}></ModalComponent>
        </div>
    );
}

export default FreeshipVoucherModal;
