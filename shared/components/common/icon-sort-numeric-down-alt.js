...
function IconSortNumericDownAlt (props) {
    return (
        <div className="icon-sort-numeric-down-alt" style={{ fontSize: props.fontSize ?? 20 }}>
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-sort-numeric-down-alt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
