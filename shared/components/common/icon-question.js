...
function IconQuestion (props) {
    return (
        <div className="icon-question d-center" style={{ fontSize: props.fontSize ?? 20 }}>
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-patch-question" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
