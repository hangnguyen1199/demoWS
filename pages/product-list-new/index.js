const ProductListNewContainer = dynamic(
    () => import('@spo/containers/product-list-new'),
    { ssr: true },
);
...
const ProductListNew = (props) => {
    ...
    useEffect(() => {
        dispatch({
            ...
            data: {
                data: router.query,
                Type: constants.PRODUCT_TYPE.NEWEST,
            },
        });
    }, [router.query]);
    return (
...
ProductListNew.Layout = SpoLayout;
